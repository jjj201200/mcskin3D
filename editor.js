...
function SkinEditor() {
    ...
    this.loadSkin = function (url, alex) {
        ...
        skin_img.onerror = loadSkinError;
    };
    ...
    this.cast_ray = function (x, y, require_color) { //拾取
...
var materials = [
    new THREE.MeshBasicMaterial({ color: 16777215, vertexColors: THREE.FaceColors, side: THREE.DoubleSide, overdraw: 1 }),
    new THREE.MeshBasicMaterial({ visible: false, opacity: 0 }),
    new THREE.MeshBasicMaterial({ color: 15658734, wireframe: true, wireframeLinewidth: 0.3 }),
    new THREE.MeshBasicMaterial({ color: 4473924, wireframe: true, wireframeLinewidth: 0.3 })
];
...
var FACES = [
    new Face("left", "z", "y", new THREE.Matrix3(1, 0, 1, 0, 0, 1, 0, 0, 0)),
    new Face("right", "z", "y", new THREE.Matrix3(0, 0, 0, 0, 0, 1, 0, 0, 0)),
    new Face("top", "x", "z", new THREE.Matrix3(0, 0, 1, 0, 0, 0, 0, 0, 0)),
    new Face("bottom", "x", "z", new THREE.Matrix3(1, 0, 1, 0, 0, 0, 0, 0, 0), true),
    new Face("front", "x", "y", new THREE.Matrix3(0, 0, 1, 0, 0, 1, 0, 0, 0)),
    new Face("back", "x", "y", new THREE.Matrix3(1, 0, 2, 0, 0, 1, 0, 0, 0))
];
